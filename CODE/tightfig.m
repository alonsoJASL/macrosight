...
% instead.
%
% THIS FUNCTION was taken from the contribution by Richard Crozier. 
% Who we thank for a wonderful contribution. Find the original code at:
% 
% https://uk.mathworks.com/matlabcentral/fileexchange/34055-tightfig-hfig
%
    if nargin == 0
        hfig = gcf;
    end
